...
const mailsRouter = express.Router({ mergeParams: true });
 ...
 */
mailsRouter.post("/", requireAuth, validate(postValidator), postController.createNotmalPost);
 ...
 */
mailsRouter.post("/pause", requireAuth, postController.pausePost);
