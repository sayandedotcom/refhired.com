...
const applyRouter = express.Router({ mergeParams: true });
 ...
 */
applyRouter.post("/", requireAuth, validate(postValidator), postController.createNotmalPost);
 ...
 */
applyRouter.post("/pause", requireAuth, postController.pausePost);
