 ...
 */
authRouter.post("/", requireAuth, validate(postValidator), postController.createNotmalPost);
 ...
 */
authRouter.post("/referral", requireAuth, validate(referralPostValidator), postController.createReferralPost);
 ...
 */
authRouter.post("/pause", requireAuth, postController.pausePost);
