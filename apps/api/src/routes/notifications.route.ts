 ...
 */
notificationsRouter.post("/", requireAuth, validate(postValidator), postController.createNotmalPost);
 ...
 */
notificationsRouter.post("/pause", requireAuth, postController.pausePost);
