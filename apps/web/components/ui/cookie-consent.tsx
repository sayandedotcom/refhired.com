...
export default function CookieConsent({
  ...
  return (
    <div
      ...
      <div className="dark:bg-secondary bg-background border-border m-3 rounded-md border shadow-lg dark:shadow-none">
        <div className="grid gap-2">
          <div className="border-border dark:border-background/20 flex h-14 items-center justify-between border-b p-4">
