...
// import { ogImageSchema } from "@/lib/validators";

// export const runtime = "edge";

// // const interRegular = fetch(
// //   new URL("../../../public/fonts/inter-font/Inter-Regular.ttf", import.meta.url)
// // ).then((res) => res.arrayBuffer());

// // const interBold = fetch(new URL("../../../public/fonts/cal-sans/CalSans-SemiBold.ttf", import.meta.url)).then(
// //   (res) => res.arrayBuffer()
// // );
